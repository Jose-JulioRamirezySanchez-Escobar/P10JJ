...
#
# Modos de uso:
#   bash scripts_sh/show_urls.sh                # regenera docs/URLS.md + resumen
#   bash scripts_sh/show_urls.sh --dry-run      # NO escribe, vuelca contenido a stdout
#   bash scripts_sh/show_urls.sh --stdout-only  # alias de --dry-run
#
